...
Leemos los datos y realizamos el scatter-plot de elevación y temperatura anual.
...
Quitamos dos outliers del dataset.
...
Vamos a buscar el valor de `h` óptimo con el método Leave-one-out cross validation (LOOCV).
